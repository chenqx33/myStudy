package chenqx.effectivejava.chapter2.item2;


/**
 * path:https://github.com/chenqx33/Effective-Java-3rd-edition-Chinese-English-bilingual/blob/dev/Chapter-2/Chapter-2-Item-2-Consider-a-builder-when-faced-with-many-constructor-parameters.md
 */
